...
const analyzeResumeWithJd = asyncHandler(async (req, res) => {
  ...
  input: `Job Description: ${jobDescription}, Resume: ${resumeData.text}, provide a match score from 1-100, list any missing skills or qualifications, and suggest improvements to enhance the resume's alignment with the job description. Summarize your findings in a concise report.`,
    text: {
    format: {
      type: "json_schema",
      name: "ResumeAnalysis",
